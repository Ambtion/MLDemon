...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_resource "${PODS_ROOT}/SYToastView/SYToastView/Resource/popup_alert.png"
  install_resource "${PODS_ROOT}/SYToastView/SYToastView/Resource/popup_alert@2x.png"
fi
